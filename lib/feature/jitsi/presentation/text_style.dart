...
class MyTextStyle {
  ...
  static const TextStyle CpS16W600 = TextStyle(
      fontSize: 16,
      fontWeight: FontWeight.w600,
      color: MyColors.purple300,
      decoration: TextDecoration.none);
  ...
  static const TextStyle CwS20W400 = TextStyle(
      fontSize: 20.0,
      fontWeight: FontWeight.w400,
      color: Colors.white,
      decoration: TextDecoration.none);

  static const TextStyle CwS20W600 = TextStyle(
      fontSize: 20.0,
      fontWeight: FontWeight.w600,
      color: Colors.white,
      decoration: TextDecoration.none);
  ...
  static const TextStyle CwS24W500H1 = TextStyle(
      height: 1.0,
      fontSize: 24,
      fontWeight: FontWeight.w500,
      color: Colors.white,
  ...
  static const TextStyle CwS26W500H1 = TextStyle(
      height: 1.0,
      fontSize: 26,
      fontWeight: FontWeight.w500,
      color: Colors.white,
      decoration: TextDecoration.none);
  static const TextStyle CrS12W600 = TextStyle(
      fontSize: 12,
      fontWeight: FontWeight.w600,
      color: Colors.red,
      decoration: TextDecoration.none);
